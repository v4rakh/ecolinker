...
build-local:
	$(GO) build -trimpath -ldflags="-s -w" -o ${BIN_DIR}/ecolinker-${GOOS}-${GOARCH} ${CMD_GO_FILES}
...
build-freebsd-amd64:
	GOOS=freebsd GOARCH=amd64 $(GO) build -trimpath -ldflags="-s -w" -o ${BIN_DIR}/ecolinker-freebsd-amd64 ${CMD_GO_FILES}
build-freebsd-arm64:
	GOOS=freebsd GOARCH=arm64 $(GO) build -trimpath -ldflags="-s -w" -o ${BIN_DIR}/ecolinker-freebsd-arm64 ${CMD_GO_FILES}
build-darwin-amd64:
	GOOS=darwin GOARCH=amd64 $(GO) build -trimpath -ldflags="-s -w" -o ${BIN_DIR}/ecolinker-darwin-amd64 ${CMD_GO_FILES}
build-darwin-arm64:
	GOOS=darwin GOARCH=arm64 $(GO) build -trimpath -ldflags="-s -w" -o ${BIN_DIR}/ecolinker-darwin-arm64 ${CMD_GO_FILES}
build-linux-amd64:
	GOOS=linux GOARCH=amd64 $(GO) build -trimpath -ldflags="-s -w" -o ${BIN_DIR}/ecolinker-linux-amd64 ${CMD_GO_FILES}
build-linux-arm64:
	GOOS=linux GOARCH=arm64 $(GO) build -trimpath -ldflags="-s -w" -o ${BIN_DIR}/ecolinker-linux-arm64 ${CMD_GO_FILES}
build-windows-amd64:
	GOOS=windows GOARCH=amd64 $(GO) build -trimpath -ldflags="-s -w" -o ${BIN_DIR}/ecolinker-windows-amd64 ${CMD_GO_FILES}
build-windows-arm64:
	GOOS=windows GOARCH=arm64 $(GO) build -trimpath -ldflags="-s -w" -o ${BIN_DIR}/ecolinker-windows-arm64 ${CMD_GO_FILES}
